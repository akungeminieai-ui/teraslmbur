...
const dummyOrders = [
  ...
  { code: 'ORD-002', customer: 'Steve Houdini', type: 'Dine In', table: 'Table 9', items: 9, status: OrderStatus.CONFIRMED, total: '24.50 EGP', time: '14:28' },
  ...
  { code: 'ORD-005', customer: 'Yuki Tanaka', type: 'Delivery', table: '-', items: 7, status: OrderStatus.ON_DELIVERY, total: '42.60 EGP', time: '13:55' },
  { code: 'ORD-006', customer: 'Ahmad Faisal', type: 'Dine In', table: 'Table 5', items: 4, status: OrderStatus.PENDING, total: '18.90 EGP', time: '13:48' },
