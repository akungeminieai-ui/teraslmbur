...
export function StatCard({ label, value, trend, icon: Icon, className }: StatCardProps) {
  return (
    <div
      className={cn(
        'group relative overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--card)] p-5',
        'transition-all duration-200 hover:border-[var(--muted-foreground)]/30 hover:shadow-md',
        className,
      )}
    >
